...
import { ResolvedStatement, getResolvedStatementFromParseResult } from "./get-resolved-statement";

const cases: {
  query: string;
  only?: boolean;
  expected: ResolvedStatement["targets"];
}[] = [
  {
    query: `SELECT * FROM caregiver`,
    expected: [{ kind: "table-star", table: { name: "caregiver", alias: undefined } }],
  },
  {
    query: `SELECT * FROM caregiver as c`,
    expected: [{ kind: "table-star", table: { name: "caregiver", alias: "c" } }],
  },
  {
    query: `
      SELECT caregiver.*
  ...
  },
  {
    ...
    expected: [{ kind: "column", table: { name: "caregiver", alias: "c" }, column: "id" }],
  },
  {
  ...
  },
  {
    ...
    expected: [{ kind: "column", table: { name: "caregiver", alias: undefined }, column: "name" }],
  },
  {
    query: `
    ...
    `,
    expected: [
      { kind: "column", table: { name: "caregiver", alias: "c" }, column: "name" },
      { kind: "column", table: { name: "agency", alias: "a" }, column: "location" },
    ],
  },
  {
...
export const getTargetSourcesTE = flow(
  ...
  taskEither.map((x) => getResolvedStatementFromParseResult(x).targets)
);
