...
const cases: {
  ...
  { query: `SELECT tbl.col IS NOT NULL AS is_col_not_null FROM tbl`, expected: ["is_col_not_null"] },
  { query: `SELECT tbl.col IS NULL AS is_col_null FROM tbl`, expected: ["is_col_null"] },
